  ...
  return (
    <header className="absolute inset-x-0 top-0 z-20 px-4 py-5 sm:px-8 lg:px-14 lg:py-8">
      <div className="mx-auto flex max-w-[1280px] items-center justify-between gap-3">
        <a href="#inicio" className="flex h-12 w-40 items-center justify-center rounded-full bg-white px-5 shadow-lg transition-transform hover:scale-105 sm:h-14 sm:w-44" aria-label="LUTSA Transportes, ir a inicio">
          <img src="/seccion01/svg/btn_lutsa_superior.svg" alt="LUTSA Transportes" className="h-full w-full object-contain" />
        </a>
