    ...
    <header className="absolute inset-0 z-20 px-4 py-5 sm:px-8 lg:px-10 lg:py-8">
      <div className="mx-auto flex h-full max-w-[1280px] flex-col">
        <div className="flex items-center justify-between gap-3">
          <a href="#inicio" className="flex h-9 items-center justify-center gap-2 rounded-full border-2 border-[#243292] bg-white px-5 py-0.5 shadow-lg transition-colors hover:bg-[#f0f3ff]" aria-label="LUTSA Transportes, ir a inicio"><img src="/seccion01/svg/logo-lutsa.svg" alt="LUTSA Transportes" className="h-3.5 w-auto object-contain" /></a>
